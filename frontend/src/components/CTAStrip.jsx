  ...
  return (
    <section className="relative py-28 md:py-40 overflow-hidden" data-testid="cta-strip">
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 30% 50%, rgba(255,179,0,0.12) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(255,179,0,0.06) 0%, transparent 50%)',
        }}
      />
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        ...
        <FadeUp delay={0.5}>
          <div className="mt-16 grid sm:grid-cols-2 gap-6 max-w-2xl">
            <a href="mailto:info@smartcompany.co.za" className="group flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.02] px-6 py-5 hover:border-[#FFB300]/50 transition-all" data-testid="cta-email-link">
              <div className="h-10 w-10 rounded-full bg-[#FFB300]/10 flex items-center justify-center text-[#FFB300]">
                <Mail size={18} />
              </div>
              <div>
            ...
            <a href="tel:+27632393273" className="group flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.02] px-6 py-5 hover:border-[#FFB300]/50 transition-all" data-testid="cta-phone-link">
              <div className="h-10 w-10 rounded-full bg-[#FFB300]/10 flex items-center justify-center text-[#FFB300]">
                <Phone size={18} />
              </div>
              <div>
